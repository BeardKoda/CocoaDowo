/*! jQuery v3.2.1 | (c) JS Foundation and other contributors | jquery.org/license */ ! function (e, t) {
    ...
    var xe = function (e) {
        function t(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : R) !== D && O(t), t = t || D, M)) {
                if (11 !== d && (l = ye.exec(e)))
                    if (r = l[1]) {
                        if (9 === d) {
            ...
            var r = n.length > 0,
                ...
                s = function (i, s, a, l, c) {
                    var u, p, f, h = 0,
                        ...
                        _ = x.length;
                    for (c && (S = s === D || s || c); d !== _ && null != (u = x[d]); d++) {
                        if (o && u) {
                            for (p = 0, s || u.ownerDocument === D || (O(u), a = !M); f = e[p++];)
                                if (f(u, s || D, a)) {
                                    l.push(u);
                                    break
                                } c && (F = b)
        ...
        var x, b, w, _, E, T, C, j, S, A, k, O, D, N, M, I, L, H, P, q = "sizzle" + 1 * new Date,
            R = e.document,
            F = 0,
            z = 0,
            W = n(),
        ...
        b = t.support = {}, E = t.isXML = function (e) {
            ...
            return i !== D && 9 === i.nodeType && i.documentElement ? (D = i, N = D.documentElement, M = !E(D), R !== D && (n = D.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", we, !1) : n.attachEvent && n.attachEvent("onunload", we)), b.attributes = r(function (e) {
                return e.className = "i", !e.getAttribute("className")
            }), b.getElementsByTagName = r(function (e) {
                return e.appendChild(D.createComment("")), !e.getElementsByTagName("*").length
            }), b.getElementsByClassName = de.test(D.getElementsByClassName), b.getById = r(function (e) {
            ...
            }, L = [], I = [], (b.qsa = de.test(D.querySelectorAll)) && (r(function (e) {
            ...
            })), (b.matchesSelector = de.test(H = N.matches || N.webkitMatchesSelector || N.mozMatchesSelector || N.oMatchesSelector || N.msMatchesSelector)) && r(function (e) {
                b.disconnectedMatch = H.call(e, "*"), H.call(e, "[s!='']:x"), L.push("!=", ie)
            }), I = I.length && new RegExp(I.join("|")), L = L.length && new RegExp(L.join("|")), t = de.test(N.compareDocumentPosition), P = t || de.test(N.contains) ? function (e, t) {
                ...
                return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !b.sortDetached && t.compareDocumentPosition(e) === n ? e === D || e.ownerDocument === R && P(R, e) ? -1 : t === D || t.ownerDocument === R && P(R, t) ? 1 : A ? J(A, e) - J(A, t) : 0 : 4 & n ? -1 : 1)
            } : function (e, t) {
                if (e === t) return k = !0, 0;
                var n, i = 0,
                    r = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== D && O(e), n = n.replace(le, "='$1']"), b.matchesSelector && M && !B[n + " "] && (!L || !L.test(n)) && (!I || !I.test(n))) try {
                var i = H.call(e, n);
    ...
    de.fn.ready = function (e) {
        ...
        readyWait: 1,
        ready: function (e) {
            (!0 === e ? --de.readyWait : de.isReady) || (de.isReady = !0, !0 !== e && --de.readyWait > 0 || De.resolveWith(te, [de]))
        }
    }), de.ready.then = De.then, "complete" === te.readyState || "loading" !== te.readyState && !te.documentElement.doScroll ? e.setTimeout(de.ready) : (te.addEventListener("DOMContentLoaded", p), e.addEventListener("load", p));
    ...
    de.extend({
        ...
        css: function (e, t, n, i) {
            var r, o, s, a = de.camelCase(t);
            return lt.test(t) || (t = L(a)), (s = de.cssHooks[t] || de.cssHooks[a]) && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = N(e, t, i)), "normal" === r && t in ut && (r = ut[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    ...
    de.ajaxSetup({
        ...
        de.cssHooks[t] = M(fe.pixelPosition, function (e, n) {
            if (n) return n = N(e, t), ot.test(n) ? de(e).position()[t] + "px" : n
        })
    }), de.each({
        Height: "height",
        Width: "width"
...
function (e, t) {
    ...
    function N(e, t, n, r) {
        ...
        s.addEventListener(t, n, {
            passive: !0
        }), o || N(i(s.parentNode), t, n, r), r.push(s)
    }
...
function (e, t) {
        ...
        for (var i = (new window.DOMParser).parseFromString(e, "text/html"), r = Object.keys(t), o = [].slice.call(i.body.querySelectorAll("*")), s = 0, a = o.length; s < a; s++) ! function (e, n) {
            ...
            a.forEach(function (e) {
                (function (e, t) {
                    ...
                    if (-1 !== t.indexOf(n)) return -1 === Ae.indexOf(n) || Boolean(e.nodeValue.match(Oe) || e.nodeValue.match(De));
    ...
    var C = "carousel",
        ...
        R = function () {
            ...
            return n.next = function () {
                ...
                return e = o({}, O, e), l.typeCheckConfig(C, e, D), e
                ...
                if (o = e === N ? (i = "carousel-item-left", r = "carousel-item-next", "left") : (i = "carousel-item-right", r = "carousel-item-prev", "right"), u && t(u).hasClass(L)) this._isSliding = !1;
    ...
    t.fn[Ne] = Xe._jQueryInterface, t.fn[Ne].Constructor = Xe, t.fn[Ne].noConflict = function () {
        return t.fn[Ne] = Le, Xe._jQueryInterface
    };
    var Qe = "popover",
        Ye = "bs.popover",
        Ge = "." + Ye,
...
var MODULE_CONFIG = {
        ...
        plyr: ["../libs/plyrist/src/plyrist.css", "../libs/plyrist/src/plyrist.js", "../libs/plyr/dist/plyr.css", "../libs/plyr/dist/plyr.polyfilled.min.js", "../assets/js/plugins/plyr.js"]
    },
...
function (e) {
    ...
    /iPhone|iPod|iPad|Silk|Android|BlackBerry|Opera Mini|IEMobile/.test(i) && e("body").addClass("touch"),
        ...
        /iPhone|iPod|iPad/.test(i) && e(document, ".modal, .aside").on("shown.bs.modal", function (t) {
        ...
        e(document).on("click", "[data-nav] a", function (t) {
            var n, i, r, o = e(this);
            r = (i = o.parent()).parents("li"), n = i.closest("[data-nav]").find(".active"), r.addClass("active"), o.next().is("ul") && i.toggleClass("active") && t.preventDefault() || i.addClass("active"), n.not(r).not(i).removeClass("active"), o.attr("href") && "#" != o.attr("href") && e(document).trigger("Nav:changed")
        }),
        // toggleClass
    ...
    var r = function () {
        e('[data-toggle="popover"]').popover(), e('[data-toggle="tooltip"]').tooltip(),
            // init the plugin
            e(document).find("[data-plugin]").plugin(), sr.reveal(".sr .card, .sr .list-item, .sr .item, .sr .sr-item", {
