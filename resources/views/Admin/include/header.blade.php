<div id="header" class="page-header">
    <div class="navbar navbar-expand-lg"><a href="" class="navbar-brand d-lg-none"><svg width="32"
            ...
            </svg> <span class="hidden-folded d-inline l-s-n-1x d-lg-none">CocoDowo</span></a>
            ...
            <li class="nav-item dropdown"><a class="nav-link px-2" data-toggle="dropdown"><i
                ...
                <div class="dropdown-menu dropdown-menu-center mt-3 w animate fadeIn">
                    <div class="setting px-3">
                        ...
                        <div class="mb-2"><a href="dashboard.html"
                                class="btn btn-sm btn-white no-ajax">Default</a> <a href="layout.a5523.html?bg"
                                class="btn btn-sm btn-white no-ajax">A</a></div>
                    </div>
                </div>
            </li>
                    ...
                    <div class="scrollable hover" style="max-height: 250px">
                        <div class="list list-row">
                            <div class="list-item" data-id="12">
                                ...
                                <div class="flex">
                                    <div class="item-feed h-2x"><a href="#">Support</a> team updated the status
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="list-item" data-id="9">
                                <div><a href="#"><span class="w-32 avatar gd-info"><img
                                                src="../assets/img/a9.jpg" alt="."></span></a></div>
                                <div class="flex">
                                    <div class="item-feed h-2x">Added to <a href="#">@TUT</a> team</div>
                                </div>
                            </div>
                            ...
                            <div class="list-item" data-id="4">
                                ...
                                <div class="flex">
                                    <div class="item-feed h-2x">Big News! Introducing <a href="#">NextUX</a>
                                        Enterprise 2.1 - additional #Windows Server support</div>
                                </div>
                            </div>
                        </div>
                    </div>
