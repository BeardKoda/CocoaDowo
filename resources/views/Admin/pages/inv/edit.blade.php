...
<div class="row row-sm sr">
  ...
  <div class="col-md-8">
      <div class="card">
          <div class="card-header"><strong>Edit Artists</strong></div>
          <div class="card-body">
              <form method="POST" action="{{route('admin-artists-save', $user->id)}}">
                {{ csrf_field() }}
                      ...
                      <div class="form-group col-md-12">
                        <label for="inputState" class="text-muted d-block">Premium Status</label>
