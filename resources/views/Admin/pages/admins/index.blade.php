        ...
        <table class="table table-theme table-row v-middle">
            ...
            @if(count($users) > 0)
                ...
                <tr class="v-middle">
                    ...
                    <td><span class="item-amount d-none d-sm-block text-sm">{{$user->position}}</span></td>
                    <td>
                    ...
                    <td>
                        <div class="item-action dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right bg-black" role="menu">
                                <a class="dropdown-item edit" href="{{route('admin-edit', $user->id)}}">Edit</a>
                                @if($user->status == "active")
                                <a class="dropdown-item edit" href="{{route('admin-suspend', $user->id)}}">Suspend</a>
                                @else
                                <a class="dropdown-item edit" href="{{route('admin-unsuspend', $user->id)}}">Unsuspend</a>
                                @endif
                                <a class="dropdown-item edit" href="{{route('admin-delete', $user->id)}}">delete</a>
                            </div>
                        </div>
                    </td>
                </tr>
