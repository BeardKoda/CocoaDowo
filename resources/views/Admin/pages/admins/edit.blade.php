...
<div class="row row-sm sr">
  ...
  <div class="col-md-8">
      <div class="card">
          ...
          <div class="card-body">
              <form method="POST" action="{{route('admin-save', $user->id)}}">
                {{ csrf_field() }}
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <select class="custom-select" name="role" value="{{$user->position}}" required style="background-color: inherit;
                            border-color: rgba(135,150,165,.15); border-width: 1px;border-radius: .25rem;color: inherit;">
                            <option selected="selected">{{$user->position}}</option>
