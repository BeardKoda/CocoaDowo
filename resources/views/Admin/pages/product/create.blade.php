              ...
              <form method="POST" action="{{ route('products.store') }}">
                {{ csrf_field() }}
                      <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" name="pname" required placeholder="Enter Farm Title">
                        @if ($errors->has('pname'))
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control" name="desc" required>Enter Farm Description</textarea>
                        @if ($errors->has('desc'))
                            <span class="help-block">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        border-width: 1px;border-radius: .25rem;color: inherit;">
                            <option selected="selected" disabled>Choose Farm Type</option>
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" name="price" required placeholder="Enter Farm price">
                        @if ($errors->has('price'))
                            <span class="help-block">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" name="duration" required placeholder="Enter Farm Duration">
